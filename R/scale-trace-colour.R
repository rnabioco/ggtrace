...
scale_trace_colour_continuous <- function(..., type = getOption("ggplot2.continuous.colour")) {
  ...
  if (is.function(type)) {
    ...
    scale_colour_gradient(
      ...
      guide = guide_colourbar(available_aes = "trace_colour")
    )
    ...
    scale_colour_viridis_c(
      ...,
      aesthetics = "trace_colour",
      guide = guide_colorbar(available_aes = "trace_colour")
    )
...
#' @usage NULL
#' @export
scale_trace_color_continuous <- scale_trace_colour_continuous

#' @rdname scale_trace_colour_continuous
#' @export
scale_trace_colour_binned <- function(..., type = getOption("ggplot2.binned.colour")) {
...
#' @usage NULL
#' @export
scale_trace_color_binned <- scale_trace_colour_binned
