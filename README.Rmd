...
`geom_point_trace` accepts graphical parameters normally passed to `geom_point` to control the appearance of data points. The appearance of the group outline can be controlled using the following additional parameters, `trace_color`, `trace_size`, `trace_linetype`, and `trace_alpha`. 
...
Like other `ggplot2` geoms, variables can be mapped to the new aesthetic attributes.
...
A set of `scale_trace_*` functions allows additional control of outline aesthetics.
