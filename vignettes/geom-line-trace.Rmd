...
p <- ggplot(stocks, aes(day, value, fill = name)) +
  theme_minimal()
...
The 'position' of the outline can be modified with the `trace_position` parameter. This can be 'all' or a predicate selecting the stocksa to outline. By default 'all' groups are outlined.

If a predicate is passed to `trace_position`, it must evaluate to `TRUE` or `FALSE` within the context of the input stocksa.
